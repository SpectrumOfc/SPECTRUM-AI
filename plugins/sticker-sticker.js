...
const handler = async (m, {conn, args, usedPrefix, command}) => {
  ...
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      else return m.reply('🚨 𝐎𝐜𝐮𝐫𝐫𝐢ó 𝐮𝐧 𝐞𝐫𝐫𝐨𝐫, 𝐢𝐧𝐭é𝐧𝐭𝐚𝐥𝐨 𝐧𝐮𝐞𝐯𝐚𝐦𝐞𝐧𝐭𝐞 𝐨 𝐜𝐨𝐦𝐮𝐧𝐢𝐜𝐚𝐭𝐞 𝐜𝐨𝐧 𝐬𝐨𝐩𝐨𝐫𝐭𝐞.');
    }
  } catch (e) {
    console.error(e);
    if (!stiker) stiker = e;
    ...
    else throw '🚨 𝐎𝐜𝐮𝐫𝐫𝐢ó 𝐮𝐧 𝐞𝐫𝐫𝐨𝐫, 𝐢𝐧𝐭é𝐧𝐭𝐚𝐥𝐨 𝐧𝐮𝐞𝐯𝐚𝐦𝐞𝐧𝐭𝐞 𝐨 𝐜𝐨𝐦𝐮𝐧𝐢𝐜𝐚𝐭𝐞 𝐜𝐨𝐧 𝐬𝐨𝐩𝐨𝐫𝐭𝐞.';
  }
};
handler.help = ['sfull'];
